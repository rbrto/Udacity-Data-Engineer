...
run_quality_checks = DataQualityOperator(
    ...
    redshift_conn_id="redshift",
    dq_checks=[
        {'table': 'songplays', 'check_sql': 'SELECT COUNT(*) FROM songplays WHERE songid is NULL' , 'expected_result': 0},
        {'table': 'users', 'check_sql': 'SELECT COUNT(*) FROM users WHERE userid is NULL', 'expected_result': 0 },
